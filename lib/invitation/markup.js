...
/**
 * Balisage standard d'une invitation, partagé par les thèmes.
 *
 * Les thèmes se distinguent surtout par leur CSS : ils stylent les mêmes
 * classes (`hero`, `block`, `timeline`, `rsvp-*`…). Un thème qui veut une
