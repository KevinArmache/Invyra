...
import { FINAL_FIGURES } from "@/lib/invitation/themes/origami/figures";
import { render } from "@/lib/invitation/themes/origami/markup";
import { css } from "@/lib/invitation/themes/origami/styles";
import { script, staticScript } from "@/lib/invitation/themes/origami/effects";
import { renderOrigamiOpening } from "@/lib/invitation/themes/origami/opening";
...
const origami = {
  ...
  // L'ouverture est propre au thème : le choix enveloppe / cachet / rideau
  // n'a pas d'effet ici.
