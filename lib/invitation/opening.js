 ...
 * du thème démarrent pendant que l'écran s'efface, et les scripts qui ont
 * appelé `window.whenOpened(fn)` sont lancés.
 *
 * Couleurs et polices : celles du thème (variables --c-* et --f-*), avec des
 ...
 * que n'importe quel script (thème, template code) puisse différer son
