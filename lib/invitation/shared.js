/**
 * Briques communes à tous les thèmes d'invitation.
 *
 * Un thème ne fait que la mise en page et le CSS. Tout ce qui doit être
 * identique d'un thème à l'autre vit ici :
 * - l'échappement des valeurs saisies ;
 * - la liste des polices proposées ;
 * - le schéma du contenu, commun à tous les thèmes pour qu'on puisse changer
 *   de thème sans retaper les textes ;
...
/**
 * Sections de l'invitation, dans leur ordre d'affichage. Chaque thème les
 ...
 * `portal.themes.sections.<section>` et `portal.themes.fields.<champ>`.
 */
 ...
 * valeurs renseignées sont affichées. Les valeurs sont brutes : le thème les
 * échappe au rendu.
 */
...
/**
 * Bloc RSVP. Le balisage suit le contrat attendu par RSVP_SCRIPT ; les thèmes
...
/**
 * Script RSVP des thèmes. Il relaie la réponse au parent par postMessage
