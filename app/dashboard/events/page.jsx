        ...
        <Card>
          <CardContent className="py-16 text-center">
            ...
            <h3 className="text-lg font-medium text-foreground mb-2">
              {search
                ? t("portal.events.list.no_events_found")
                : t("portal.events.list.no_events_yet")}
            </h3>
            <p className="text-muted-foreground mb-4">
              {search
                ? t("portal.events.list.try_different_search")
                : t("portal.events.list.create_first_event")}
            </p>
            {!search && (
              <Button asChild>
                <Link href="/dashboard/events/new">
              ...
              <CardContent className="p-6">
                ...
                <div className="flex flex-wrap items-center justify-between gap-3 pt-4 border-t border-border">
                  <div className="flex items-center gap-2 text-sm text-muted-foreground">
                    <Users size={16} />
                    <span>
                      {event.guest_count || 0} {t("portal.events.list.guests")}
                    </span>
                  </div>
                  <span
                    className={`inline-flex max-w-full items-center justify-center whitespace-normal wrap-break-word px-2.5 py-1 rounded-full text-xs font-medium leading-tight ${
                      event.status === "active"
        ...
        <DialogContent className="max-w-[95vw] md:max-w-[600px] h-[90vh] p-0 overflow-hidden bg-black border border-border">
          ...
          {previewEvent && previewEvent.invitationTemplate ? (
            ...
            <div className="w-full h-full flex flex-col items-center justify-center text-center p-6 text-muted-foreground">
              ...
              <Link
                href={`/dashboard/events/${previewEvent?.id}/template`}
