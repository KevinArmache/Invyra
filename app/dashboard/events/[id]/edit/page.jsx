...
export default function EditEventPage({ params }) {
  ...
  const activeTemplate = event.invitationTemplate || {
    type: "code",
    html: "",
    css: "",
  };
    ...
    <div className="h-[calc(100vh-5rem)] flex flex-col gap-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <Button onClick={handleSubmit} disabled={loading} className="gap-2">
            ...
            {loading ? "Enregistrement..." : "Sauvegarder et quitter"}
          </Button>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col min-h-0">
        ...
        <div className="flex-1 grid lg:grid-cols-[1fr_450px] xl:grid-cols-[1fr_500px] gap-6 min-h-0">
          {/* Left: Form */}
          <div
            className={`overflow-y-auto space-y-6 pb-20 custom-scrollbar ${activeMode === "edit" ? "block" : "hidden lg:block"}`}
          >
            <Card>
              <CardHeader>
                <CardTitle>Informations principales</CardTitle>
                <CardDescription>
                  Les détails qui apparaîtront sur l'invitation
                </CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Un message chaleureux pour accompagner l'invitation
                  (Optionnel)
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Le modèle utilisé pour l'affichage de l'invitation
                </CardDescription>
              </CardHeader>
              <CardContent>
                {event.invitationTemplate ? (
                  <div className="flex items-center gap-2 text-xs text-green-500 font-medium bg-green-500/10 px-3 py-2 rounded-lg border border-green-500/20">
                    <Check className="w-4 h-4" /> Modèle actif — visible dans
                    l'aperçu à droite
                  </div>
                ) : (
                  <p className="text-sm text-muted-foreground">
                    Aucun modèle sélectionné. Un modèle par défaut est utilisé.
                  </p>
                )}
              </CardContent>
            </Card>
          ...
          {/* Right: Live Preview */}
          <div
            className={`relative rounded-xl border border-border overflow-hidden bg-muted/20 h-full shadow-inner flex items-center justify-center p-0 lg:p-4 ${activeMode === "preview" ? "flex" : "hidden lg:flex"}`}
          >
            ...
            <div className="p-6 border-b border-border flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-0.5">
                  Sélectionnez un modèle pour l'appliquer à cet événement
                </p>
              </div>
              <button
                type="button"
            ...
            {savedTemplates.length > 0 && (
              <div className="p-4 border-t border-border flex justify-end gap-3">
                ...
                <button
                  ...
                  disabled={!selectedForSwap || swapping}
